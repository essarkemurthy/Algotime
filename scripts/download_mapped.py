...
SYMBOLS = [
    # ── Indices (all 4 intervals) ─────────────────────────────────────────────
    ("BSESEN", "BSE", "SENSEX",        "index"),
    ("NIFFIN", "NSE", "FINNIFTY",      "index"),
    ("NIFMID", "NSE", "MIDCPNIFTY",    "index"),
    ("CNXBAN", "NSE", "BANKNIFTY",     "index"),
    ("NIFFIN", "NSE", "NIFTYFINSERV",  "index"),
    ("CNXINF", "NSE", "NIFTYINFRA",    "index"),
    ("NIFMID", "NSE", "NIFTYMIDCAP50", "index"),
    ("NIFNEX", "NSE", "NIFTYNEXT50",   "index"),
    ("CNXPSE", "NSE", "NIFTYPSE",      "index"),

    # ── Nifty50 stocks — Breeze internal codes (5m, 30m, 1d) ─────────────────
    ("SBILIF", "NSE", "SBILIFE",   "nifty50"),
    ("ZOMLIM", "NSE", "ETERNAL",   "nifty50"),
    ("TATMOT", "NSE", "TATAMOTORS","nifty50"),
    ("RELIND", "NSE", "RELIANCE",  "nifty50"),
    ("INFTEC", "NSE", "INFY",      "nifty50"),
    ("HDFBAN", "NSE", "HDFCBANK",  "nifty50"),
    ("ICIBAN", "NSE", "ICICIBANK", "nifty50"),
    ("HINLEV", "NSE", "HINDUNILVR","nifty50"),
    ("STABAN", "NSE", "SBIN",      "nifty50"),
    ("BHAAIR", "NSE", "BHARTIARTL","nifty50"),
    ("KOTMAH", "NSE", "KOTAKBANK", "nifty50"),
    ("AXIBAN", "NSE", "AXISBANK",  "nifty50"),
    ("LARTOU", "NSE", "LT",        "nifty50"),
    ("ASIPAI", "NSE", "ASIANPAINT","nifty50"),
    ("SUNPHA", "NSE", "SUNPHARMA", "nifty50"),
    ("ULTCEM", "NSE", "ULTRACEMCO","nifty50"),
    ("NESIND", "NSE", "NESTLEIND", "nifty50"),
    ("POWGRI", "NSE", "POWERGRID", "nifty50"),
    ("COALIN", "NSE", "COALINDIA", "nifty50"),
    ("TATSTE", "NSE", "TATASTEEL", "nifty50"),
    ("JSWSTE", "NSE", "JSWSTEEL",  "nifty50"),
    ("ADAENT", "NSE", "ADANIENT",  "nifty50"),
    ("ADAPOR", "NSE", "ADANIPORTS","nifty50"),
    ("BAJFI",  "NSE", "BAJFINANCE","nifty50"),
    ("BAFINS", "NSE", "BAJAJFINSV","nifty50"),
    ("HCLTEC", "NSE", "HCLTECH",   "nifty50"),
    ("TECMAH", "NSE", "TECHM",     "nifty50"),
    ("TITIND", "NSE", "TITAN",     "nifty50"),
    ("DRREDD", "NSE", "DRREDDY",   "nifty50"),
    ("BRIIND", "NSE", "BRITANNIA", "nifty50"),
    ("EICMOT", "NSE", "EICHERMOT", "nifty50"),
    ("HERHON", "NSE", "HEROMOTOCO","nifty50"),
    ("HINDAL", "NSE", "HINDALCO",  "nifty50"),
    ("INDBA",  "NSE", "INDUSINDBK","nifty50"),
    ("APOHOS", "NSE", "APOLLOHOSP","nifty50"),
    ("BHAPET", "NSE", "BPCL",      "nifty50"),
    ("BHAELE", "NSE", "BEL",       "nifty50"),
    ("HDFSTA", "NSE", "HDFCLIFE",  "nifty50"),
    ("SHRTRA", "NSE", "SHRIRAMFIN","nifty50"),
    ("BAAUTO", "NSE", "BAJAJ-AUTO","nifty50"),

    # ── Bank Nifty constituents (5m, 30m, 1d) ────────────────────────────────
    ("AUSMA",  "NSE", "AUBANK",    "nifty50"),
    ("PUNBAN", "NSE", "PNB",       "nifty50"),
    ("BANBAN", "NSE", "BANDHANBNK","nifty50"),
    ("FEDBAN", "NSE", "FEDERALBNK","nifty50"),
    ("IDFBAN", "NSE", "IDFCFIRSTB","nifty50"),

    # ── Next50 stocks — Breeze internal codes (30m, 1d) ──────────────────────
    ("AMBCE",  "NSE", "AMBUJACEM", "next50"),
    ("BERPAI", "NSE", "BERGEPAINT","next50"),
    ("BANBAR", "NSE", "BANKBARODA","next50"),
    ("CANBAN", "NSE", "CANBK",     "next50"),
    ("CHOINV", "NSE", "CHOLAFIN",  "next50"),
    ("DABIND", "NSE", "DABUR",     "next50"),
    ("DLFLIM", "NSE", "DLF",       "next50"),
    ("GODCON", "NSE", "GODREJCP",  "next50"),
    ("HAVIND", "NSE", "HAVELLS",   "next50"),
    ("ICIPRU", "NSE", "ICICIPRULI","next50"),
    ("INDRAI", "NSE", "IRCTC",     "next50"),
    ("JINSP",  "NSE", "JINDALSTEL","next50"),
    ("MARLIM", "NSE", "MARICO",    "next50"),
    ("MUTFIN", "NSE", "MUTHOOTFIN","next50"),
    ("INFEDG", "NSE", "NAUKRI",    "next50"),
    ("PIDIND", "NSE", "PIDILITIND","next50"),
    ("RURELE", "NSE", "RECLTD",    "next50"),
    ("SIEMEN", "NSE", "SIEMENS",   "next50"),
    ("TORPHA", "NSE", "TORNTPHARM","next50"),
    ("VEDLIM", "NSE", "VEDL",      "next50"),
    ("AVESUP", "NSE", "DMART",     "next50"),
    ("MAHMAH", "NSE", "M&M",       "next50"),
    ("ICILOM", "NSE", "ICICIGI",   "next50"),
    ("DIVLAB", "NSE", "DIVISLAB",  "next50"),
    ("GODPRO", "NSE", "GODREJPROP","next50"),
    ("MANAFI", "NSE", "MANAPPURAM","next50"),
    ("UNISPI", "NSE", "MCDOWELL-N","next50"),

    # ── Originally Next50 mapped (30m, 1d) ───────────────────────────────────
    ...
    # ── Extra stocks requiring Breeze codes (1d only) ────────────────────────
    ("ABB",    "NSE", "ABB",       "additional"),
    ("ADAGRE", "NSE", "ADANIGREEN","additional"),
    ("ADAPOW", "NSE", "ADANIPOWER","additional"),
    ("ADAGAS", "NSE", "ATGL",      "additional"),
    ("BAJHOU", "NSE", "BAJAJHFL",  "additional"),
    ("BHEL",   "NSE", "BHEL",      "additional"),
    ("BOSLIM", "NSE", "BOSCHLTD",  "additional"),
    ("NIITEC", "NSE", "COFORGE",   "additional"),
    ("CONCOR", "NSE", "CONCOR",    "additional"),
    ("HINDAL", "NSE", "HINDALCO",  "additional"),  # also nifty50 above; ON CONFLICT ignored
    ("HINPET", "NSE", "HINDPETRO", "additional"),
    ("HINZIN", "NSE", "HINDZINC",  "additional"),
    ("KPITE",  "NSE", "KPIT",      "additional"),
    ("LTTEC",  "NSE", "LTTS",      "additional"),
    ("MOILIM", "NSE", "MOIL",      "additional"),
    ("NHPC",   "NSE", "NHPC",      "additional"),
    ("NATMIN", "NSE", "NMDC",      "additional"),
    ("PREEST", "NSE", "PRESTIGE",  "additional"),
    ("RADKHA", "NSE", "RADICO",    "additional"),
    ("SAIL",   "NSE", "SAIL",      "additional"),
    ("SRF",    "NSE", "SRF",       "additional"),
    ("TATCOM", "NSE", "TATACOMM",  "additional"),
    ("TATPOW", "NSE", "TATAPOWER", "additional"),
    ("TVSMOT", "NSE", "TVSMOTOR",  "additional"),
    ("VARBEV", "NSE", "VBL",       "additional"),
    ("VOLTAS", "NSE", "VOLTAS",    "additional"),
    ("CADHEA", "NSE", "ZYDUSLIFE", "additional"),
    ("INDOIL", "NSE", "IOC",       "additional"),
    ("MPHLIM", "NSE", "MPHASIS",   "additional"),
    ("MOTSUM", "NSE", "MOTHERSON", "additional"),
    ("OBEREA", "NSE", "OBEROIRLTY","additional"),
    ("PERSYS", "NSE", "PERSISTENT","additional"),
    ("UNIP",   "NSE", "UPL",       "additional"),
    ("HINLEV", "NSE", "HINDUNILVR","additional"),  # also nifty50; ON CONFLICT ignored

    # ── Originally Additional mapped (1d only) ────────────────────────────────
